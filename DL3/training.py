        ...
        for i in range(label.shape[1]):
            ...
            if is_inside:
                ...
                if save_image:
                    ...
                    cv2.circle(image, (int(label[batch_i, i, 0]*image.shape[1]), int(label[batch_i, i, 1]*image.shape[0])), 2, (0, 255, 0), -1)
        ...
        for i in range(label.shape[1]):
            ...
            try:
                if is_inside:
                    ...
                    my_pred = prediction[batch_i, i:i+1, :, :] # shape: 1, H, W
                    grid_loss = loss_bce(my_pred, ground_truth) + 0.5*loss_bce(my_pred[0,grid_num_y, grid_num_x], ground_truth[0,grid_num_y, grid_num_x])
                    ...
                    loss = grid_loss/2 + offset_loss*5
